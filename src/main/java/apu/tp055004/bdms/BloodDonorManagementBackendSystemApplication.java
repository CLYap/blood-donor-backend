...
public class BloodDonorManagementBackendSystemApplication {
	...
	CommandLineRunner run(AppUserService appUserService, BloodCentreService bloodCentreService, StaffService staffService, DonorService donorService) {
		return args -> {
			...
			BloodCentre bloodCentre = bloodCentreService.saveBloodCentre(new BloodCentre(null, "Pantai Hospital", "address", null, null));
			bloodCentreService.saveBloodCentre(new BloodCentre(null, "Pantai Hospital2", "address2", null, null));
			bloodCentreService.saveBloodCentre(new BloodCentre(null, "Pantai Hospital3", "address3", null, null));
			
			AppUser appUserAdmin = appUserService.saveUser(new AppUser("cheecomanyemail@gmail.com", "1234", new ArrayList<>()));
			staffService.saveStaff(new Staff("S0001", "Yap", "Chee Ling", "F", "12/03/1999", "address", "cheeling222@gmail.com", "0129299922", bloodCentre, appUserAdmin));
			...
			staffService.saveStaff(new Staff("S0002", "Chin", "Ling", "M", "10/01/1988", "address2", "chinling@hotmail.com", "0192888833", bloodCentre, appUserNurse));
			appUserService.addRoleToUser("cheecomanyemailnurse@gmail.com", "ROLE_NURSE");
			
			AppUser appUserDonor = appUserService.saveUser(new AppUser("001203146818", "12345", new ArrayList<>()));
			donorService.saveDonor(new Donor("D0001", "Lee", "Don", "M", "03/03/1988", "addressdonor1", "addressdonor2", "citydonor", "statedonor", "56000", "O-", 54, 188, new ArrayList<MedicalHistory>(), new ArrayList<Allergy>(), "019277722", "leedon@outlook.com", appUserDonor ));
			appUserService.addRoleToUser("001203146818", "ROLE_DONOR");
