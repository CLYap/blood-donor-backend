...
public class BloodDonorManagementBackendSystemApplication {
	...
	//used to create existing accounts for staffs and donors
	@Bean
...
//			
//			AppUser appUserNurse6 = appUserService.saveUser(new AppUser("cheelingnurse@nationalblood.com", "12345nurse", new ArrayList<>()));
//			staffService.saveStaff(new Staff("Chee Ling", "Lee", "F", new SimpleDateFormat("dd-MM-yyyy").parse("10-11-1998"), "12A, Jalan Perdana, Bandar Kepong, KL", "cheeling@hotmail.com", "0142228833", nat, appUserNurse6));
//			appUserService.addRoleToUser("cheelingnurse@nationalblood.com", "ROLE_NURSE");
//			
//			AppUser appUserNurse7 = appUserService.saveUser(new AppUser("christannurse@nationalblood.com", "12345nurse", new ArrayList<>()));
//			staffService.saveStaff(new Staff("Chris", "Tan", "M", new SimpleDateFormat("dd-MM-yyyy").parse("12-11-1978"), "12A, Jalan Tan Sri, Bandar Kepong, KL", "chris78@hotmail.com", "0162234833", nat, appUserNurse7));
//			appUserService.addRoleToUser("christannurse@nationalblood.com", "ROLE_NURSE");
//			
//			AppUser appUserNurse8 = appUserService.saveUser(new AppUser("pennywongnurse@nationalblood.com", "12345nurse", new ArrayList<>()));
//			staffService.saveStaff(new Staff("Penny", "Wong", "F", new SimpleDateFormat("dd-MM-yyyy").parse("10-12-1999"), "4E, Jalan Kepong, Bandar Kepong, KL", "penny99@hotmail.com", "0122238803", nat, appUserNurse8));
//			appUserService.addRoleToUser("pennywongnurse@nationalblood.com", "ROLE_NURSE");
//			
//			
...
//			
//			AppUser appUserDonor6 = appUserService.saveUser(new AppUser("011023146318", "12345donor", new ArrayList<>()));
//			donorService.saveDonor(new Donor("Sam", "Goo", "M", new SimpleDateFormat("dd-MM-yyyy").parse("23-10-2001"), "5B, Bandar Cheras", "Bandar Cheras", "Kuala Lumpur", "Wp Kuala Lumpur", "56000", "A+", 56, 160, "", "", "019233722", "samgoo@outlook.com", appUserDonor6 ));
//			appUserService.addRoleToUser("011023146318", "ROLE_DONOR");
//			
//			AppUser appUserDonor7 = appUserService.saveUser(new AppUser("001023146417", "12345donor", new ArrayList<>()));
//			donorService.saveDonor(new Donor("Chloe", "Tan", "F", new SimpleDateFormat("dd-MM-yyyy").parse("23-10-2000"), "5, Bandar Kinrara 2", "Bandar Kinrara", "Kuala Lumpur", "Selangor", "56001", "B+", 64, 176, "High Blood Pressure", "nuts", "012277723", "chloetan@hotmail.com", appUserDonor7 ));
//			appUserService.addRoleToUser("001023146417", "ROLE_DONOR");
//			
//			AppUser appUserDonor8 = appUserService.saveUser(new AppUser("991003146318", "12345donor", new ArrayList<>()));
//			donorService.saveDonor(new Donor("Crystal", "Leong", "M", new SimpleDateFormat("dd-MM-yyyy").parse("03-10-1999"), "16, Bandar Bukit", "Bandar Cheras", "Kuala Lumpur", "Wp Kuala Lumpur", "56000", "B-", 50, 167, "", "", "019277722", "crustalleong@gmail.com", appUserDonor8 ));
//			appUserService.addRoleToUser("991003146318", "ROLE_DONOR");
		};
	}
